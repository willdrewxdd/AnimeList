    ...
    return (
        <>
            <div className="pt-4 px-4">
                <h3 className="text-primary text-2xl">{anime.data.title} - {anime.data.year}</h3>
                {!collection && user && (
                    <CollectionButton
                        anime_mal_id={id}
            ...
            <div className="pt-4 px-4 gap-2 flex text-primary overflow-x-auto">
            ...
            <div className="p-4">
                <h3 className="text-primary text-2xl mb-2">Komentar Penonton</h3>
